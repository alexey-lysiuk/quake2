...
GLfloat				qglMaxAnisotropyTextureLevel;
GLfloat				qglCurAnisotropyTextureLevel;

static FILE *		gQGLLogFile = NULL;
...
void ( APIENTRY * qglTexImageProxy1D )(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
void ( APIENTRY * qglTexImageProxy2D )(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
...
static void ( APIENTRY * qglBindAnisotropic)(GLenum target, GLuint texture);
...
static void ( APIENTRY * dllEdgeFlagPointer )(GLsizei stride, const GLboolean *pointer);
...
static void ( APIENTRY * dllTexImage1D )(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
static void ( APIENTRY * dllTexImage2D )(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
static void ( APIENTRY * dllTexImageProxy1D )(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
static void ( APIENTRY * dllTexImageProxy2D )(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
...
{
	fprintf( gQGLLogFile, "glAlphaFunc( 0x%x, %f )\n", (unsigned int) func, ref );
...
{
	fprintf( gQGLLogFile, "glBegin( 0x%x )\n", (unsigned int) mode );
	dllBegin( mode );
}
...
{
	fprintf( gQGLLogFile, "glBindTexture( 0x%x, %u )\n", (unsigned int) target, (unsigned int) texture );
...
{
	fprintf( gQGLLogFile, "glBlendFunc( 0x%x, 0x%x )\n", (unsigned int) sfactor, (unsigned int) dfactor );
...
{
	fprintf( gQGLLogFile, "glCallList( %u )\n", (unsigned int) list );
	dllCallList( list );
}
...
{
	fprintf( gQGLLogFile, "glDisable( 0x%x )\n", (unsigned int) cap );
	dllDisable( cap );
}
...
{
	fprintf( gQGLLogFile, "glEnable( 0x%x )\n", (unsigned int) cap );
	dllEnable( cap );
}
...
{
	fprintf( gQGLLogFile, "glPolygonMode( 0x%x, 0x%x )\n", (unsigned int) face, (unsigned int) mode );
...
{
	fprintf( gQGLLogFile, "glTexParameterf( 0x%x, 0x%x, %f )\n", (unsigned int) target, (unsigned int) pname, param );
...
{
	fprintf( gQGLLogFile, "glTexParameteri( 0x%x, 0x%x, 0x%x )\n", (unsigned int) target, (unsigned int) pname, (unsigned int) param );
...
static void APIENTRY qglBindAnisotropicTexture (GLenum theTarget, GLuint theTexture)
{
        qglBindAnisotropic (theTarget, theTexture);
...
void	qglEnableAnisotropicTexture (qboolean theState)
{
    if (theState == true)
    {
        qglBindAnisotropic = qglBindTexture;
        qglBindTexture = dllBindTexture = qglBindAnisotropicTexture;
        glGetFloatv (GL_MAX_TEXTURE_MAX_ANISOTROPY_EXT, &qglMaxAnisotropyTextureLevel);
        qglCurAnisotropyTextureLevel = 1.0f;
    }
    else
    {
        qglBindAnisotropic = NULL;
        qglMaxAnisotropyTextureLevel = 1.0f;
        qglCurAnisotropyTextureLevel = 1.0f;
    }
}
...
qboolean	QGL_SafeTexImage (GLenum theTarget, GLint theLevel, GLenum theInternalFormat, GLsizei theWidth, GLsizei theHeight, GLsizei theDepth, GLint theBorder, GLenum theFormat, GLenum theType)
{
    GLint	myWidth = -1;
    GLenum	myError;
	GLenum	myTarget;
    ...
    switch (theTarget)
    {
        ...
        case GL_PROXY_TEXTURE_1D:
            ...
            qglTexImageProxy1D (myTarget, theLevel, theInternalFormat, theWidth, theBorder, theFormat, theType, NULL); 
            break;
			
        case GL_TEXTURE_2D:
        case GL_PROXY_TEXTURE_2D:
            myTarget = GL_PROXY_TEXTURE_2D;
            qglTexImageProxy2D (myTarget, theLevel, theInternalFormat, theWidth, theHeight, theBorder, theFormat, theType, NULL); 
            break;
			
//        case GL_TEXTURE_3D:
//        case GL_PROXY_TEXTURE_3D:
//            myTarget = GL_PROXY_TEXTURE_3D;
//            qglTexImageProxy3D (myTarget, theLevel, theInternalFormat, theWidth, theHeight, theDepth, theBorder, theFormat, theType, NULL); 
//            break;
...
void	QGL_SafeTexImage1D (GLenum theTarget, GLint theLevel, GLenum theInternalFormat, GLsizei theWidth, GLint theBorder, GLenum theFormat, GLenum theType, const GLvoid *thePixels)
{
    qboolean	mySuccess = QGL_SafeTexImage (theTarget, theLevel, theInternalFormat, theWidth, 0, 0, theBorder, theFormat, theType);
                                  
    if (mySuccess == true)
    {
        qglTexImageProxy1D (theTarget, theLevel, theInternalFormat, theWidth, theBorder, theFormat, theType, thePixels);
    }
}

//------------------------------------------------------------------------------------------------------------------------------------------------------------

void	QGL_SafeTexImage2D (GLenum theTarget, GLint theLevel, GLenum theInternalFormat, GLsizei theWidth, GLsizei theHeight, GLint theBorder, GLenum theFormat, GLenum theType, const GLvoid *thePixels)
{
    qboolean	mySuccess = QGL_SafeTexImage (theTarget, theLevel, theInternalFormat, theWidth, theHeight, 0, theBorder, theFormat, theType);
                                  
    if (mySuccess == true)
    {
        qglTexImageProxy2D (theTarget, theLevel, theInternalFormat, theWidth, theHeight, theBorder, theFormat, theType, thePixels);
    }
}
...
void	QGL_Shutdown (void)
{
    ...
    qglTexImage1D                = NULL;
    qglTexImage2D                = NULL;
    qglTexImageProxy1D           = NULL;
    qglTexImageProxy2D           = NULL;
...
qboolean QGL_Init (const char *dllname)
{
    ...
    qglTexImageProxy1D           = dllTexImageProxy1D           = GPA ("glTexImage1D");
    qglTexImageProxy2D           = dllTexImageProxy2D           = GPA ("glTexImage2D");
    ...
    qglTexImage1D                = dllTexImage1D                = QGL_SafeTexImage1D;
    qglTexImage2D                = dllTexImage2D                = QGL_SafeTexImage2D;
...
void GLimp_EnableLogging (qboolean theEnable)
{
    if (theEnable == true)
    {
        ...
        qglTexImageProxy1D           = logTexImage1D;
        qglTexImageProxy2D           = logTexImage2D;
	...
	else
    {
        ...
        qglTexImageProxy1D           = dllTexImageProxy1D;
        qglTexImageProxy2D           = dllTexImageProxy2D;
